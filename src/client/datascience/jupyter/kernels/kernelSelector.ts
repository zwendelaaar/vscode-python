...
export class KernelSelector {
    ...
    public async selectRemoteKernel(
        ...
        return this.selectKernel(stopWatch, Telemetry.SelectRemoteJupyterKernel, suggestions, session, cancelToken, currentKernel);
    }
    /**
    ...
    public async selectLocalKernel(
        ...
        suggestions = suggestions.filter(item => !this.kernelIdsToHide.has(item.selection.kernelModel?.id || ''));
        return this.selectKernel(stopWatch, Telemetry.SelectLocalJupyterKernel, suggestions, session, cancelToken, currentKernel);
    }
    /**
